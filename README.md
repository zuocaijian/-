...
* **其它工具**  
	...
	13、个人总结的安卓学习笔记。自定义View系列文章很经典，需要多看多理解。[AndroidNote](https://github.com/GcsSloop/AndroidNote)  

	13、树莓派官方资料文档[raspberrypi/documentation](https://github.com/raspberrypi/documentation)  

	14、树莓派各型号全部镜像合集[awesome-raspberry-pi](https://github.com/thibmaek/awesome-raspberry-pi)  

	15、技术面试需要掌握的基础知识整理。包括算法、操作系统、网络、数据库、分布式、面向对象等。[Interview-Notebook](https://github.com/CyC2018/Interview-Notebook)  

	16、面试知识点资料整理。[interviews](https://github.com/kdn251/interviews)  

	17、多人协作的开源项目：Android系统源码解读。[BeesAndroid](https://github.com/BeesAndroid/BeesAndroid)  

	18、Java设计模式。[java-design-patterns](https://github.com/iluwatar/java-design-patterns)  

	19、Android RxJava学习资料。包括入门、原理、操作符、实际应用开发等一系列教程文章。[RxJava_Util](https://github.com/Carson-Ho/RxJava_Util)  

	20、Android学习资源，包括博客博文、知名开发者、开发社区、网站等。[Android-Learning-Resources](https://github.com/zhujun2730/Android-Learning-Resources)  

	21、Android基础知识、进阶知识、面试相关资料总结。[AndroidNote](https://github.com/linsir6/AndroidNote)  

	22、个人写的的Android Framework曾源码解析，目前好像已经停止维护。[androidSource](https://github.com/yipianfengye/androidSource)  

	23、翻译国外Android优质技术、开源库、软件架构设计、测试等文章的开源项目。目前已停止维护。[android-tech-frontier](https://github.com/hehonghui/android-tech-frontier)  

	24、Android开发工具类集合。包括支付、分享、压缩、UCrop选择圆形头像、二维码和条形码的扫描与生成、定位、图片缩放等等。[RxTools](https://github.com/vondear/RxTools)  
...
* **demo**  
	...
	7、小说阅读器。可以用来参考了解模拟翻页效果怎么实现，以及如何加载文字等自定义View的实现。[BookReader](https://github.com/JustWayward/BookReader)  

	8、六种方法判断App位于前台或者后台。最后一种可以突破Android5.0以上的权限封锁。[AndroidProcess](https://github.com/wenmingvs/AndroidProcess)  

	9、来疯手机安卓视频直播开源项目，纯Java编写。[SopCastComponent](https://github.com/LaiFeng-Android/SopCastComponent)  

### 知名开源项目  
 - 百度 阿波罗自动驾驶 [apollo](https://github.com/ApolloAuto/apollo)  
 - NASA 阿波罗11号制导部分开源代码[Apollo-11](https://github.com/chrislgarry/Apollo-11/blob/master/README.zh_cn.md)  
 - 阿里巴巴 路由框架 [ARouter](https://github.com/alibaba/ARouter)
	 > **作用**：电商活动页面动态下发，以及组件化开发  
 - square IO优化库[okio](https://github.com/square/okio)  
 - square restful风格网络封装库[retrofit](https://github.com/square/retrofit)  
 - square 网络请求库[okhttp](https://github.com/square/okhttp)  
 - linux内核开发项目[linux](https://github.com/torvalds/linux)  
 - google 人工智能开发框架 [tensorflow](https://github.com/tensorflow/tensorflow)  
 - bumptech google推荐使用的图片加载框架。源码非常优秀，值得学习。[glide](https://github.com/bumptech/glide)  
 - FFmpeg 视频编解码库[FFmpeg](https://github.com/FFmpeg/FFmpeg)  
...
4、利用Python进行数据分析 第二版(2017)中文翻译笔记[pydata-notebook](https://github.com/BrambleXu/pydata-notebook)  
...
4、百度网盘Python命令行客户端[bypy](https://github.com/houtianze/bypy)  

5、leetcode算法题答案参考[leetcode](https://github.com/haoel/leetcode)  
